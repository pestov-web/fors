  ...
  <main id="main" tabindex="-1">
    <?php
      ...
      $faqItems = [
        [
          'author' => 'Аня',
          'question' => 'Здравствуйте! Подскажите, пожалуйста, могу ли я восстановиться на занятия, если по личным причинам не завершила курс: ни теорию, ни практику (50 часов вождения)? Нужно ли доплачивать и сколько?',
          'expert' => 'Юрист',
          'answer' => 'Добрый день, всё зависит от срока действия вашего договора. Обратитесь, пожалуйста, в центральный офис на ул. Плехановская, 35, чтобы менеджеры подсказали путь восстановления.',
        ],
        [
          'author' => 'Аня',
          'question' => 'Здравствуйте! Подскажите, пожалуйста, могу ли я восстановиться на занятия, если по личным причинам не завершила курс: ни теорию, ни практику (50 часов вождения)? Нужно ли доплачивать и сколько?',
          'expert' => 'Юрист',
          'answer' => 'Здравствуйте! Первым делом проверьте срок договора. Если он ещё действует, мы восстановим вас на ближайший поток. Для уточнения условий подходите в офис на ул. Плехановская, 35.',
        ],
        [
          'author' => 'Аня',
          'question' => 'Здравствуйте! Подскажите, пожалуйста, могу ли я восстановиться на занятия, если по личным причинам не завершила курс: ни теорию, ни практику (50 часов вождения)? Нужно ли доплачивать и сколько?',
          'expert' => 'Юрист',
          'answer' => 'Добрый день! Возможность восстановления зависит от того, истёк ли договор и сколько занятий осталось пройти. Подробно расскажем при личном визите в офис на ул. Плехановская, 35.',
        ],
        [
          'author' => 'Аня',
          'question' => 'Здравствуйте! Подскажите, пожалуйста, могу ли я восстановиться на занятия, если по личным причинам не завершила курс: ни теорию, ни практику (50 часов вождения)? Нужно ли доплачивать и сколько?',
          'expert' => 'Юрист',
          'answer' => 'Здравствуйте! После проверки договора менеджер предложит возможный график возврата и рассчитает, потребуется ли доплата. Ждём вас в центральном офисе на ул. Плехановская, 35.',
        ],
        [
          'author' => 'Аня',
          'question' => 'Здравствуйте! Подскажите, пожалуйста, могу ли я восстановиться на занятия, если по личным причинам не завершила курс: ни теорию, ни практику (50 часов вождения)? Нужно ли доплачивать и сколько?',
          'expert' => 'Юрист',
          'answer' => 'Добрый день! Чаще всего требуется только заявление и согласование новой программы. Приходите в офис на ул. Плехановская, 35 — специалисты помогут оформить восстановление.',
        ],
      ];
    ?>
