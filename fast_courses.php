...
<html lang="ru">
  ...
  <body>
    ...
    $breadcrumbItems = [["title" =>
      "Главная", "url" => "/"], ["title" => "Ускоренные курсы вождения"]]; include __DIR__ .
        ...
        <div class="u-container fast-hero__inner">
          <div class="fast-hero__content">
            ...
            <div class="fast-hero__grid">
              <p>
                Ускоренные курсы вождения — отличный выбор для тех, кто ценит своё свободное время. В автошколе «Форсаж»
                работают лучшие инструкторы Воронежа, готовые научить студентов всем тонкостям управления транспортом
                в кратчайшие сроки. Несмотря на то что прохождение программы идёт быстрее, умения ученика будут
                на высоком уровне. Самый важный нюанс заключается в том, что количество практических часов
                не уменьшается, а проработка материала остаётся качественной.
              </p>
              <p>
                График подбирается в индивидуальном порядке, под удобные клиенту дни. Будущего водителя ждут
                как теоретические, так и практические занятия на современных и хорошо обслуживаемых транспортных
                средствах. Экспресс-обучение не привязано к конкретной категории. Пройти его могут как будущие
                мотоциклисты, так и те, кто открывает группу «Е» для управления транспортными средствами с прицепами
                и полуприцепами.
              </p>
            </div>
          </div>
      ...
      <section class="page-section fast-benefits" aria-labelledby="fast-benefits-title">
        <div class="u-container">
          <div class="fast-section-heading fast-section-heading--center">
            <h2 class="fast-section-heading__title" id="fast-benefits-title">
              Преимущества экспресс-курса обучения вождению
            </h2>
            <p class="fast-section-heading__subtitle">
              Ускоряем процесс получения прав — сохраняя высокое качество подготовки и контроль результатов на каждом
              этапе.
            </p>
          </div>
          <div class="fast-benefits__grid">
            <article class="fast-benefit-card">
              <div class="fast-benefit-card__body">
                <h3 class="fast-benefit-card__title">
                  Выбор
                  <br />
                  расписания практики
                  <br />
              ...
              <figure class="fast-benefit-card__media">
                <img
                  src="assets/img/fast-benefits/benefit-1.png"
                  alt="Автомобиль автошколы с инструктором"
                  loading="lazy"
                  decoding="async"
                  width="315"
                  height="192"
            ...
            <article class="fast-benefit-card">
              ...
              <figure class="fast-benefit-card__media">
                <img
                  src="assets/img/fast-benefits/benefit-2.png"
                  alt="Учебный автомобиль на автодроме"
                  loading="lazy"
                  decoding="async"
                  width="315"
                  height="192"
            ...
            <article class="fast-benefit-card">
              ...
              <figure class="fast-benefit-card__media">
                <img
                  src="assets/img/fast-benefits/benefit-3.png"
                  alt="Информационный стенд автошколы Форсаж"
                  loading="lazy"
                  decoding="async"
                  width="315"
                  height="192"
            ...
            <article class="fast-benefit-card">
              ...
              <figure class="fast-benefit-card__media">
                <img
                  src="assets/img/fast-benefits/benefit-4.png"
                  alt="Выпускница автошколы празднует сдачу экзамена"
                  loading="lazy"
                  decoding="async"
                  width="315"
                  height="192"
      ...
      <section class="page-section page-section--light" aria-labelledby="fast-steps-title">
        <div class="u-container">
          <div class="fast-section-heading fast-section-heading--center">
            <h2 class="fast-section-heading__title" id="fast-steps-title">
              Этапы получения водительского удостоверения
            </h2>
            <p class="fast-section-heading__subtitle">
              Подготовили ускоренный маршрут — от первого звонка до экзаменов в ГИБДД.
            </p>
          </div>
        ...
        <div class="u-container">
          ...
          <div class="fast-docs__grid">
            ...
            <article class="fast-doc-card">
              ...
              <img
                class="fast-doc-card__image"
                src="assets/img/driver_proof.png"
      ...
      <section class="page-section page-section--light fast-why" aria-labelledby="fast-why-title">
        <div class="u-container">
          <div class="fast-section-heading fast-section-heading--center">
            ...
            <p class="fast-section-heading__subtitle">
              Наша автошкола — одна из старейших в Воронеже. Ученики «Форсажа» получают множество преимуществ:
            </p>
          </div>
          <div class="why-grid">
            ...
            <article class="why-card why-card--photo">
              <div class="why-card__icon">
                <picture>
                  <img
                    src="assets/img/why-img.png"
                    alt="Фотография учеников автошколы"
                    loading="lazy"
                    decoding="async"
                    width="480"
                    height="320"
            ...
            <article class="why-card why-card--autodrome">
              <div class="why-card__icon" aria-hidden="true">
                <img
                  src="assets/icons/courses/autodrom.svg"
                  alt=""
                  width="48"
                  height="48"
                  loading="lazy"
            ...
            <article class="why-card why-card--branches">
              <div class="why-card__icon" aria-hidden="true">
                <img
                  src="assets/icons/courses/filials.svg"
                  alt=""
                  width="48"
                  height="48"
                  loading="lazy"
            ...
            <article class="why-card why-card--transparent">
              <div class="why-card__icon" aria-hidden="true">
                <img
                  src="assets/icons/courses/prices.svg"
                  alt=""
                  width="48"
                  height="48"
                  loading="lazy"
              ...
              <p class="why-card__caption">
                Никаких скрытых платежей и дополнительных квитанций, например, за ГСМ и аренду тренировочной площадки.
              </p>
            </article>
            ...
            <article class="why-card why-card--instructors">
              <div class="why-card__icon" aria-hidden="true">
                <img
                  src="assets/icons/courses/professionals.svg"
                  alt=""
                  width="48"
                  height="48"
                  loading="lazy"
      ...
      <section class="page-section fast-pricing" aria-labelledby="fast-pricing-title">
        <div class="u-container">
          <div class="fast-section-heading fast-section-heading--center">
            ...
            <p class="fast-section-heading__subtitle">
              Экспресс-группы открываем каждый месяц. Выберите нужную категорию и формат обучения.
            </p>
          </div>
              ...
              <tbody>
                <tr>
                  <th scope="row">
                    <div class="pricing-course">
                      <span class="pricing-course__icon">
                        <img src="assets/icons/courses/moto-table.svg" alt="" width="32" height="32" />
                      </span>
                ...
                <tr>
                  <th scope="row">
                    <div class="pricing-course">
                      <span class="pricing-course__icon">
                        <img src="assets/icons/courses/car-table.svg" alt="" width="32" height="32" />
                      </span>
                ...
                <tr>
                  <th scope="row">
                    <div class="pricing-course">
                      <span class="pricing-course__icon">
                        <img src="assets/icons/courses/truck-table.svg" alt="" width="32" height="32" />
                      </span>
                ...
                <tr>
                  <th scope="row">
                    <div class="pricing-course">
                      <span class="pricing-course__icon">
                        <img src="assets/icons/courses/bus-table.svg" alt="" width="32" height="32" />
                      </span>
