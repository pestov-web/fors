...
?>
<header class="site-header site-header--inner" role="banner">
  <div class="site-header__inner u-container">
    ...
    <div class="site-header__actions">
      ...
      <!-- ПЕРЕКЛЮЧАТЕЛЬ ТЕМЫ -->
      <button class="action-btn action-btn--theme action-btn--theme-light"
              type="button"
              role="switch"
              aria-checked="false"
    ...
    <div class="site-menu__panel" role="dialog" aria-modal="true" aria-labelledby="site-menu-title" tabindex="-1">
      ...
      <nav class="site-menu__nav" aria-label="Быстрые ссылки">
        <ul class="site-menu__list" role="list">
          ...
          <li class="site-menu__item">
            <a class="site-menu__link" href="fast_courses.php">Ускоренные курсы вождения</a>
          </li>
          <li class="site-menu__item">
            <a class="site-menu__link" href="schedule.php">Расписание занятий</a>
          </li>
          <li class="site-menu__item">
          ...
          <li class="site-menu__item">
            <a class="site-menu__link" href="news_element.php">Новость: Дополнительная скидка 13%</a>
          </li>
          <li class="site-menu__item">
            <a class="site-menu__link" href="gallery.php">Фотогалерея</a>
          </li>
          <li class="site-menu__item">
            <a class="site-menu__link" href="search.php">Поиск</a>
          </li>
          <li class="site-menu__item">
            <a class="site-menu__link" href="contacts.php">Контакты</a>
          </li>
          <li class="site-menu__item">
            <a class="site-menu__link" href="404.php">Страница 404</a>
          </li>
        </ul>
      </nav>
    </div>
