    ...
    <section class="home-hero" aria-labelledby="hero-title">
      <div class="home-hero__container">
        ...
        <!-- <figure class="home-hero__media" aria-hidden="true">
          <picture>
            <img
              class="home-hero__car"
              src="assets/img/car_n.png"
              alt="Автомобиль автошколы Форсаж"
              loading="eager"
              decoding="async"
              fetchpriority="high"
              width="1810"
